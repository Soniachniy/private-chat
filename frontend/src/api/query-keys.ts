...
export const queryKeys = {
    ...
    nearai: {
        ...
        messageSignature: (model: string, chatCompletionId: string, signingAlgorithm: SigningAlgorithm) => [NEARAI_KEY, "messageSignature", model, chatCompletionId, signingAlgorithm],
    },
