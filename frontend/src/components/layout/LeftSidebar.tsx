				...
				>
					...
					>
						...
						<div className="flex flex-col items-center justify-between  px-2">
							...
							<div className="flex flex-col gap-2 w-full justify-between rounded-lg  py-[6px]  group-hover:bg-gray-100 dark:group-hover:bg-gray-950 whitespace-nowrap text-ellipsis">
								{isChatsOpen &&
